                ...
                <div class="multisteps-form__panel shadow p-4 rounded background-color-custom" data-animation="fadeIn">
                    ...
                    <div class="multisteps-form__content">
                        <div class="container-fluid scroll overflow-auto custom-form">
                            ...
                            <br>
                            <div class="mb-2"><strong class="fs-4">Classroom Policy</strong> <button class="badge bg-primary rounded-pill border-0"><i class='bx bx-plus-circle'></i></button></div>
                            <ol class="list-group bg-transparent">
                                <li class="list-group-item bg-transparent text-light">
                                    <input class="form-check-input me-1" type="checkbox" value="" aria-label="...">
                                    Attendance
                                    <button class="badge bg-primary rounded-pill border-0" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class='bx bx-edit-alt'></i></button>
                                    <button class="badge bg-primary rounded-pill border-0" ><i class='bx bxs-trash'></i></button>
                                </li>
                                <li class="list-group-item bg-transparent text-light">
                                    <input class="form-check-input me-1" type="checkbox" value="" aria-label="...">
                                    Wearing of Prescribed School Uniform and ID:
                                    <button class="badge bg-primary rounded-pill border-0" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class='bx bx-edit-alt'></i></button>
                                    <button class="badge bg-primary rounded-pill border-0" ><i class='bx bxs-trash'></i></button>
                                </li>
                                <li class="list-group-item bg-transparent text-light">
                                    <input class="form-check-input me-1" type="checkbox" value="" aria-label="...">
                                    Cleanliness and Room Organization:
                                    <button class="badge bg-primary rounded-pill border-0" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class='bx bx-edit-alt'></i></button>
                                    <button class="badge bg-primary rounded-pill border-0" ><i class='bx bxs-trash'></i></button>
                                </li>
                            </ol>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content bg-dark">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Attendance">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="mb-2"><strong class="fs-4">Course Rubrics</strong> <button class="badge bg-primary rounded-pill border-0"><i class='bx bx-plus-circle'></i></button></div>
                            <ol class="list-group bg-transparent">
                                <li class="list-group-item bg-transparent text-light">
                                    <input class="form-check-input me-1" type="checkbox" value="" aria-label="...">
                                    Organization
                                    <button class="badge bg-primary rounded-pill border-0" data-bs-toggle="modal" data-bs-target="#new"><i class='bx bx-edit-alt'></i></button>
                                    <button class="badge bg-primary rounded-pill border-0" ><i class='bx bxs-trash'></i></button>
                                </li>
                                <li class="list-group-item bg-transparent text-light">
                                    <input class="form-check-input me-1" type="checkbox" value="" aria-label="...">
                            ...
                            <div class="modal fade" id="new" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                    <div class="modal-content bg-dark">
                                        ...
                                        <div class="modal-body">
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Beginner 1-2/5</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Capable 3/5 </label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Accomplished 4/5 </label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Expert 5/5 </label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                        </div>
                                        </div>
                                        <div class="modal-footer">
                ...
                <div class="multisteps-form__panel shadow p-4 rounded background-color-custom" data-animation="fadeIn">
                    <div class="row mb-2">
                        <div class="col-12 col-lg-6">
                            <h3 class="multisteps-form__title">Generated Syllabus</h3>
                        </div>
